...
export const Login = () => {
    ...
    const login = async () => {
        await mutateAsync({username: username, password: password});
    }
        ...
        <div className="login flex justify-center" >
            ...
            <div className="w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
                <div className="px-6 py-4">
                    ...
                    <h3 className="mt-3 text-xl font-medium text-center text-gray-600 dark:text-gray-200">Task</h3>
                    ...
                    <p className="mt-1 text-center text-gray-500 dark:text-gray-400">Login</p>
                        ...
                        <div className="w-full mt-4">
                            <input className="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-500 bg-white border rounded-lg dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring focus:ring-blue-300"
                             type="text" placeholder="User name" aria-label="User name"
                        ...
                        <div className="flex items-center justify-between mt-4">
                            <a href="#" className="text-sm text-gray-600 dark:text-gray-200 hover:text-gray-500"></a>
                ...
                <div className="flex items-center justify-center py-4 text-center bg-gray-50 dark:bg-gray-700">
                    ...
                    <a href="#" className="mx-2 text-sm font-bold text-blue-500 dark:text-blue-400 hover:underline"></a>
                </div>
            </div>
        </div>
    )
